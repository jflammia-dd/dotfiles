...
- [Referencing Jira issues in dev work](reference_jira_dev_work.md): issue key in commit subjects and PR titles, NOT branch names (Datadog convention wins); keys case-sensitive uppercase.
